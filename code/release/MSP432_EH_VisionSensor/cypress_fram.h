...
#define FRAM_USE_DMA 0

// ***** Peripheral Definitions ***** //
#define FRAM_SPI_PERIPHERAL 		EUSCI_A1_BASE
#define FRAM_SPI_FREQUENCY		24000000
...
uint32_t EXTFRAM_read(uint32_t, void*, uint32_t);
uint32_t EXTFRAM_write(uint32_t, const void*, uint32_t);
