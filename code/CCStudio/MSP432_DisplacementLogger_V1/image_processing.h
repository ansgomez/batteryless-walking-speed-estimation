...
*/
	...
	#define BLOCKSIZE_X 				48
	#define BLOCKSIZE_X_HALF 		24
	#define BLOCKSIZE_Y 				48
	#define BLOCKSIZE_Y_HALF 		24
	#define SEARCHAREA_X_NEG 			-8
	#define SEARCHAREA_X_POS 			8
	#define SEARCHAREA_Y_NEG 			-8
	#define SEARCHAREA_Y_POS 			8

	#define EFF_NUMPIXELS_X 		96	// NUMPIXELS_X - (-SEARCHAREA_X_NEG) - SEARCHAREA_X_POS
	#define EFF_NUMPIXELS_Y 		96	// NUMPIXELS_Y - (-SEARCHAREA_Y_NEG) - SEARCHAREA_Y_POS
	#define NUMBLOCKS_X 			2	// EFF_NUMPIXELS_X/BLOCKSIZE_X
	#define NUMBLOCKS_Y 			2	// EFF_NUMPIXELS_Y/BLOCKSIZE_Y
