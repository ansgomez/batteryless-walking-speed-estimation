...
#define SD_SPI_FREQUENCY			300000			/* SPI clock Frequency for initialization */
#define SD_SPI_MAX_FREQUENCY		300000			/* max SPI clock Frequency */
...
#define SD_PORT_CS		GPIO_PORT_P4
#define SD_PIN_CS		GPIO_PIN6		// P1.4 on Demoboard!
