...
#define SERIAL_PERIPHERAL 	EUSCI_A0_BASE

// ***** IO Pin Definitions ***** //
#define SERIAL_PORT_RX		GPIO_PORT_P2
#define SERIAL_PIN_RX		GPIO_PIN0
#define SERIAL_PORT_TX		GPIO_PORT_P2
#define SERIAL_PIN_TX		GPIO_PIN1
...
//#define SERIAL_OVERSAMPLING			EUSCI_A_UART_LOW_FREQUENCY_BAUDRATE_GENERATION
//#define SERIAL_FIRST_MODULATION		0
//#define SERIAL_SECOND_MODULATION	34
...
uint16_t Serial_sendData(const void*, uint16_t);
