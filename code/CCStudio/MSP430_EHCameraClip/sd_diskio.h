...
// select if DMA is used for transmission from/to SD card (1) or not (0)
#define SD_USE_DMA		1

#define SD_SPI_FREQUENCY		400000			/* SPI clock Frequency for initialization */
#define SD_SPI_MAX_FREQUENCY	0 // SMCLK_Freq			/* max SPI clock Frequency */
#define SD_SPI_BASE				EUSCI_B0_BASE	/* EUSCI Base */

// ***** IO Pin Definitions ***** //
#define SD_PORT_CLK		GPIO_PORT_P2
#define SD_PIN_CLK		GPIO_PIN2
#define SD_PORT_MISO	GPIO_PORT_P1
#define SD_PIN_MISO		GPIO_PIN7
#define SD_PORT_MOSI	GPIO_PORT_P1
#define SD_PIN_MOSI		GPIO_PIN6
#define SD_PORT_CS		GPIO_PORT_P3
#define SD_PIN_CS		GPIO_PIN5

#define SD_PORT_POWER	GPIO_PORT_P3
#define SD_PIN_POWER	GPIO_PIN6
