...
#define FRAM_SPI_FREQUENCY		0 // SMCLK_Freq
...
#define FRAM_PIN_CLK	GPIO_PIN4
#define FRAM_PORT_MISO	GPIO_PORT_P2
#define FRAM_PIN_MISO	GPIO_PIN6
#define FRAM_PORT_MOSI	GPIO_PORT_P2
#define FRAM_PIN_MOSI	GPIO_PIN5
#define FRAM_PORT_CS	GPIO_PORT_P4
#define FRAM_PIN_CS		GPIO_PIN2

#define FRAM_PORT_POWER	GPIO_PORT_P3
#define FRAM_PIN_POWER	GPIO_PIN4
