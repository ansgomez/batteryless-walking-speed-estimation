...
// ***** IO Pin Definitions ***** //
#define EMU_VOLTAGE_SELECT1_PORT	GPIO_PORT_P2
#define EMU_VOLTAGE_SELECT1_PIN		GPIO_PIN0
#define EMU_VOLTAGE_SELECT2_PORT	GPIO_PORT_P2
#define EMU_VOLTAGE_SELECT2_PIN		GPIO_PIN1
#define EMU_VOLTAGE_SELECT3_PORT	GPIO_PORT_P4
#define EMU_VOLTAGE_SELECT3_PIN		GPIO_PIN0
#define EMU_VOLTAGE_SELECT4_PORT	GPIO_PORT_P4
#define EMU_VOLTAGE_SELECT4_PIN		GPIO_PIN1

#define EMU_BURST_SELECT1_PORT		GPIO_PORT_P1
#define EMU_BURST_SELECT1_PIN		GPIO_PIN2
#define EMU_BURST_SELECT2_PORT		GPIO_PORT_P3
#define EMU_BURST_SELECT2_PIN		GPIO_PIN0
