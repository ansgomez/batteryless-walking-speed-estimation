...
#define CAMERA_MASK_PROCESSING  1
...
#define CAMERA_PULSE_START_DELAY_TIMER_CYCLES   0 //CAMERA_TIMER_RESET_SINGLE_OFFSET_TIMER_CYCLES
...
void Camera_defineMask(uint8_t*);
