...
#define CAMERA_ANALOG_SAMPLING_DELAY		ADC12_B_CYCLEHOLD_8_CYCLES
#define CAMERA_ADC_SAMPLING_TIMER_CYCLES	8

/// The DMA channel used for the camera
#define CAMERA_DMA_CHANNEL DMA_CHANNEL_1

/// The ADC processing duration (sample+sync+conversion), to calculate from ADC configuration [value in microseconds]
#define CAMERA_ADC_TIMER_CYCLES (CAMERA_ADC_SAMPLING_TIMER_CYCLES + 14 + 1)

/// The camera pulse should have a delay of a few hundred nanoseconds [value in microseconds]
#define CAMERA_PULSE_TIMER_CYCLES 1

/// The camera amplifier activation delay of about a microseconds [value in microseconds]
#define CAMERA_AMPLIFY_TIMER_CYCLES 2

/// The camera analog read delay should be a couple of microseconds [value in microseconds]
#define CAMERA_ANALOG_TIMER_CYCLES 1

/// The timer reset value of the pixel timers, aka the pixel read duration [value in microseconds]
#define CAMERA_PIXEL_TIMER_CYCLES (CAMERA_AMPLIFY_TIMER_CYCLES + CAMERA_ANALOG_TIMER_CYCLES + CAMERA_ADC_TIMER_CYCLES + CAMERA_PULSE_TIMER_CYCLES)

/// The timer reset value of the row timer, aka the row read duration [value in microseconds]
#define CAMERA_ROW_TIMER_CYCLES ((1 + IMAGE_SIZE_COL) * CAMERA_PIXEL_TIMER_CYCLES)
