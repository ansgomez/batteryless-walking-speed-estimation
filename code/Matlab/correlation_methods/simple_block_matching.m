...
%   estimates the displacement between image ImageA and image ImageB
    ...
    numblocks_x * numblocks_y * (2*searcharea_x+1) * (2*searcharea_y+1) * (blocksize_x + blocksize_y)
             ...
             for i_search_x = (-searcharea_x):searcharea_x
                 for i_search_y = (-searcharea_y):searcharea_y
                     ...
                     for i_x = 1:blocksize_x
                         ...
                         p_I1_y = p_I1start_y + floor(blocksize_y/2);
                         p_I2_x = p_I2start_x + i_x;
                         p_I2_y = p_I2start_y + floor(blocksize_y/2);
                     ...
                     for i_y = 1:blocksize_y
                         ...
                         p_I1_x = p_I1start_x + floor(blocksize_x/2);
                         p_I1_y = p_I1start_y + i_y;
                         p_I2_x = p_I2start_x + floor(blocksize_x/2);
