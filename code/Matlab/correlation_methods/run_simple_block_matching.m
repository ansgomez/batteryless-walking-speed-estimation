...
Img1 = rgb2gray(imread('../images/image_rec2_2.png'));       % images/image8.png
Img2 = rgb2gray(imread('../images/image_rec3_2.png'));       % images/image9.png

[vx,vy] = simple_block_matching(Img1,Img2);
