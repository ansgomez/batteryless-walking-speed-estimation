...
for i = 0:(num_images-1)
    ...
    if (i > 0)
        ...
        img2(:,:) = I(:,:,i+1);
            ...
            % Histogram Method
            [dx, dy] = displacement_estimation_HIST(dx_matlab_3b, dy_matlab_3b,...
                [searcharea_x_neg searcharea_x_pos searcharea_y_neg searcharea_y_pos]);
            pos_x_hist_3(i+1) = pos_x_hist_3(i) + dx;
            pos_y_hist_3(i+1) = pos_y_hist_3(i) + dy;
            ...
            % Histogram Method
            [dx, dy] = displacement_estimation_HIST(dx_matlab_6b, dy_matlab_6b,...
                [searcharea_x_neg searcharea_x_pos searcharea_y_neg searcharea_y_pos]);
            pos_x_hist_6(i+1) = pos_x_hist_6(i) + dx;
            pos_y_hist_6(i+1) = pos_y_hist_6(i) + dy;
